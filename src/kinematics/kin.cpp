...
void Kinematics::forward(const double* q, double* T) {
...
void Kinematics::forward_all(const double* q, double* T1, double* T2, double* T3,
...
int Kinematics::inverse(const double* T, double* q_sols, double q6_des) {
    int num_sols = 0;
