...
void urdfStringSplit(vector<std::string> &pieces, const std::string &vector_str, const vector<std::string> &separators)
{
...
void urdfIsAnyOf(const char *seps, vector<std::string> &strArray)
{
